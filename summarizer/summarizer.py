            ...
            async def callback(self, interaction: discord.Interaction):
                ...
                class SearchContextDropdown(discord.ui.Select):
                    def __init__(self, parent_cog, ctx, customer_id, preferred_model, openai_api_key, selected_category):
                        ...
                        options = [
                            discord.SelectOption(label="Low", emoji="⚡", description="Least context, lowest cost, fastest response. $0.03 / search"),
                            discord.SelectOption(label="Medium", emoji="⚖️", description="Balanced context, cost, and latency. $0.035 / search"),
                            discord.SelectOption(label="High", emoji="🧠", description="Most context, highest cost, slower response. $0.05 / search")
                        ]
