    ...
    async def _send_homeworkai_response(
        ...
        if prompt_type == "ask":
            system_prompt = (
                ...
                "Answer the user's question as clearly and concisely as possible. Format math responses inside a ```codeblock``` using standard expression indicators instead of spelling out math expressions."
