...
class Translate(commands.Cog):
    ...
    def convert_language(language: str) -> str:
        language = googletrans.LANGUAGES.get(language.lower(), language).lower()
    ...
    async def set_my_language(self, ctx: commands.Context, *, language: str):
        ...
        try:
            ...
            result: Translated = await asyncio.to_thread(self.translator.translate, success, dest=language, src="auto")
